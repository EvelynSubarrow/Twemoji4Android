...
for code in [0x23,0x2a,0x30,0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39,0x20e3,0x200d,0x1f9b0,0x1f9b1,0x1f9b2,0x1f9b3,0xfe0f]+list(range(0xe0065, 0xe007F)):
	g.append("%04X" % code)
